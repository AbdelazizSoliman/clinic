    ...
    DEFINITIONS = {
      customer: {
        ...
        steps: [
          ...
          [ "النقاط والمحفظة", "راجع الرصيد والقيود التجريبية والكسب والانتهاء دون قيمة مالية حقيقية.", :customer_benefits, :view ],
          [ "استكشف منتج وصفة", "شاهد متطلبات الرفع والمراجعة دون تقديم نصيحة طبية.", :prescription_product, :view ],
          [ "بحث عربي متسامح", "ابحث «شراب ابراهيم» بألف بلا همزة وشاهد المنتج المخزَّن بهمزة.", :search_arabic_variation, :view ],
          [ "بحث عربي وإنجليزي معًا", "ابحث «فيتامين c» وشاهد ترتيب النتائج عبر الاسم والعلامة.", :search_mixed_query, :view ],
          [ "بحث بلا نتائج", "شاهد رسالة واضحة مع اقتراحات وأقسام بديلة.", :search_zero_result, :explore ]
        ]
      },
      pharmacist: {
      ...
      order_manager: {
        ...
        steps: [
          ...
          [ "المرتجعات والاسترداد", "راجع المرتجعات الجزئية مع بقاء المعاملة الأصلية ثابتة.", :returns_queue, :view ]
        ]
      },
      inventory_manager: {
      ...
      admin: {
        ...
        steps: [
          ...
          [ "إدارة الولاء والمحفظة", "راجع القواعد والقيود والتعديلات التعويضية.", :loyalty_wallet_admin, :view ],
          [ "قواعد سلامة الدواء", "راجع القواعد المُعدّة محليًا وإصداراتها دون تعديل أثناء الجولة.", :safety_rules, :view ],
          [ "مرادفات البحث", "توسيع لغوي للبحث فقط — بلا أي دلالة علاجية.", :search_synonyms, :view ],
          [ "تقرير البحث", "الأكثر بحثًا والبحث بلا نتائج ونسبة اختيار المنتجات.", :search_reports, :view ],
          [ "التحليلات التنفيذية", "قارن القنوات والفروع ضمن نطاق المؤسسة والفترة المحددة.", :admin_analytics, :view ],
