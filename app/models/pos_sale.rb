class PosSale < ApplicationRecord
  ...
  validates :subtotal_cents, :automatic_discount_cents, :manual_discount_cents, :loyalty_discount_cents,
    :wallet_paid_cents, :tax_cents, :total_cents,
  ...
  def total_is_consistent
    expected = subtotal_cents - automatic_discount_cents - manual_discount_cents - loyalty_discount_cents + tax_cents
